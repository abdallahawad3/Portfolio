  ...
  return (
    <div
      className={`sm-scope z-40 ${
        isFixed
          ? "fixed top-0 left-0 w-screen h-screen .!bg-transparent overflow-hidden"
          : "w-full h-full"
      }`}
    >
      <div
        className={
          (className ? className + " " : "") +
          "staggered-menu-wrapper relative w-full h-ful bg-transparent z-40"
        }
        style={
          accentColor
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-[2em] bg-transparent pointer-events-none z-20 backdrop-blur-xl text-foreground"
